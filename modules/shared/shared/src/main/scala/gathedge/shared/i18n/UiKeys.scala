...
object UiKeys {
  ...
  // Under a name/tag filter, zero rows is "no matches" rather than "none exist yet" — the same split
  // `adminUsersEmpty`/`adminUsersCount` draws for the user list.
  val groupsNoMatches: String             = key("ui.groups.noMatches")
  val groupsCount: String                 = pluralKey("ui.groups.count")
  val groupsFilterNameLabel: String       = key("ui.groups.filterNameLabel")
  val groupsFilterNamePlaceholder: String = key("ui.groups.filterNamePlaceholder")
  val groupsFilterTagLabel: String        = key("ui.groups.filterTagLabel")
  val groupsFilterTagPlaceholder: String  = key("ui.groups.filterTagPlaceholder")
